...
function HistoriaExito1() {
  const historiaData = {
    title: '"La Constancia y Perseverancia tienen sus frutos"',
    subtitle: '"Este lema sirve como recordatorio de que el esfuerzo sostenido, incluso en los momentos difíciles, conduce al éxito a largo plazo...',
    paragraphs: [
