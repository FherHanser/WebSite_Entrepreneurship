...
function HistoriaExito() {
  const historiaData = {
    title: '"Historias que Inspiran"',
    subtitle: '"Historias que Inspiran" es una recopilación cautivadora de relatos llenos de momentos transformadores...',
    paragraphs: [
