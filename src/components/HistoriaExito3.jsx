...
function HistoriaExito3() {
  const historiaData = {
    title: '"Deseo de Superación"',
    subtitle: '"Estos relatos inspiradores ilustran cómo el anhelo de superación impulsa a las personas a enfrentar desafíos, aprender de las adversidades y alcanzar nuevas alturas...',
    paragraphs: [
