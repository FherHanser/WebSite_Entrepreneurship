...
function HistoriaExito2() {
  const historiaData = {
    title: '"Trabajo en Familia"',
    subtitle: '"Este enfoque laboral no solo fortalece los lazos afectivos, sino que también impulsa el rendimiento y la productividad...',
    paragraphs: [
